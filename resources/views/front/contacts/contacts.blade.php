    ...
    <div class="contacts">
        ...
        <div class="contacts__place-list">
            <div class="contacts__place-item">
                <div class="contacts__place-info">
                    ...
                    <div class="contacts__cols-wrap">
                        <div class="contacts__col-1">
                            ...
                            <div class="contacts__info-item contacts__info-item--phone">8 (727) 294 86 51, 294 86 50</div>
                            <div class="contacts__info-item contacts__info-item--fax">8 (727) 252 20 33</div>
                            <div class="contacts__info-item contacts__info-item--mob">8 777 256 09 07</div>
                ...
                <div class="contacts__place-map"></div>
            </div>
