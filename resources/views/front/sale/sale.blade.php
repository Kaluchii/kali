...
@section('content')
    ...
    @include('front.rating', ['block_name' => 'sale', 'block_id' => 0, 'rating' => $rating])
    <ul class="breadcrumbs" itemprop="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
        ...
        <li class="breadcrumbs__item" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
            <a href="/sale" itemprop="item" class="hide"><span itemprop="name">{{$sale->title}}</span></a>
            <span class="breadcrumbs__current"><span class="breadcrumbs__current-text">{{$sale->title}}</span></span>
