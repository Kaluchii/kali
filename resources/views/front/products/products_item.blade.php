...
@section('content')
    ...
    @include('front.rating', ['block_name' => 'products_item', 'block_id' => $product->id, 'rating' => $rating])
    <ul class="breadcrumbs" itemprop="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
        ...
        <li class="breadcrumbs__separator"></li>
        <li class="breadcrumbs__item" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
            <a href="/products/{{$product->slug}}" itemprop="item" class="hide"><span itemprop="name">{{$product->product_name}}</span></a>
            <span class="breadcrumbs__current"><span class="breadcrumbs__current-text">{{$product->product_name}}</span></span>
