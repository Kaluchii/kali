<div class="box">
    <div class="box-header with-border">
        ...
        <button type="submit" class="btn btn-primary pull-right remove-flat-item" data-id="{{$item->id_field}}"
                data-block="guarantee_facts_list">Удалить</button>
    </div>
    ...
    <div class="box-body">
        <div class="form-group">
            ...
            <input class="form-control string"
                   ...
                   data-name="text"
                   data-type="string"
                   data-block="guarantee_facts_list"
                   data-id="{{$item->id_field}}">
        </div>
        <div class="form-group">
            <label>Изображение (125x100 пикселей)</label>
            <div class="dropzone">
                            ...
                            <div class="file-preview-frame">
                                ...
                                <div class="file-thumbnail-footer">
                                    <div class="file-actions">
                                        <input type="text" class="form-control alt-text" data-block="guarantee_facts_list"
