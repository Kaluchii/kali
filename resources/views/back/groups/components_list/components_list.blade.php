@extends('back.layout')
@section('content')
    @include('back.content-top', ['title' => 'Товар'])
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab_g1">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label>Изображение (~200x200 пикселей)</label>
                        <div class="dropzone">
                                        ...
                                        <div class="file-preview-frame">
                                            ...
                                            <div class="file-thumbnail-footer">
                                                <div class="file-actions">
                                                    <input type="text" class="form-control alt-text" data-block="components_list"
