@extends('back.layout')
@section('content')
    @include('back.content-top', ['title' => 'Категория комплектующих'])
                        ...
                        <div class="box table-widget">
                            ...
                            <div class="box-body">
                                <table class="table table-bordered table-hover dataTable table-widget-selector" role="grid"
                                    ...
                                    @foreach($item->components_list_group as $category)
                                        @include('back.groups.components_list.components_list_row',['item' => $category])
                                    @endforeach
    ...
    <input class="form-control string" type="hidden" value="{{time()}}"
           data-name="last_modified" data-type="string" data-block="components" data-id="0">

    <input class="form-control string" type="hidden" value="{{time()}}"
           data-name="last_modified" data-type="string" data-block="components_categories" data-id="{{$item->id_field}}">
