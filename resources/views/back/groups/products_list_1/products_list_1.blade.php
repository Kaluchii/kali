...
@section('content')
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control text textarea"
                                  data-name="preview_text"
                                  data-type="text"
                                  data-block="products_list_1"
                                  data-id="{{$item->id_field}}">{{$item->preview_text_field}}</textarea>
                    </div>
                    <div class="form-group">
                                        ...
                                        <div class="file-preview-frame">
                                            ...
                                            <div class="file-thumbnail-footer">
                                                <div class="file-actions">
                                                    <input type="text" class="form-control alt-text" data-block="products_list_1"
    ...
    <input class="form-control string" type="hidden" value="{{time()}}"
           data-name="last_modified" data-type="string" data-block="products_list_1" data-id="{{$item->id_field}}">
