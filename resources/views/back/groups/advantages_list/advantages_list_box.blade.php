<div class="box">
    <div class="box-header with-border">
        ...
        <button type="submit" class="btn btn-primary pull-right remove-flat-item" data-id="{{$item->id_field}}"
                data-block="advantages_list">Удалить</button>
    </div>
    ...
    <div class="box-body">
        <div class="form-group">
            ...
            <input class="form-control string"
                   ...
                   value="{{$item->advantage_title_field}}"
                   data-name="advantage_title"
                   data-type="string"
                   data-block="advantages_list"
        ...
        <div class="form-group">
            <label>Изображение (51x51 пикселей)</label>
            <div class="dropzone">
                            ...
                            <div class="file-preview-frame">
                                ...
                                <div class="file-thumbnail-footer">
                                    <div class="file-actions">
                                        <input type="text" class="form-control alt-text" data-block="advantages_list"
