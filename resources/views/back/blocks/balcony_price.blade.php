...
@section('content')
                        ...
                        <div class="box table-widget">
                            ...
                            <div class="box-body">
                                <table class="table table-bordered table-hover dataTable table-widget-selector" role="grid"
                                    ...
                                    @foreach($block->balcony_price_categories_group as $item)
                                        @include('back.groups.balcony_price_categories.balcony_price_categories_row',['item' => $item])
                                    @endforeach
    ...
    <input class="form-control string" type="hidden" value="{{time()}}"
           data-name="last_modified" data-type="string" data-block="balcony_price" data-id="0">
