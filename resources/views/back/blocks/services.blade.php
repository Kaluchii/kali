...
@section('content')
    ...
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab_g1">
                ...
                <div class="box box-info group-item-widget" data-block="services_list">
                    ...
                    <div class="box-body">
                        <div class="groupflat-widget group-item-wrap">
                            @foreach($block->services_list_group as $item)
                                @include('back.groups.services_list.services_list_box', ['item' => $item])
                            @endforeach
                        </div>
                    </div>
                </div>
    ...
    <input class="form-control string" type="hidden" value="{{time()}}"
           data-name="last_modified" data-type="string" data-block="services" data-id="0">
