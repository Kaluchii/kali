@extends('back.layout')
@section('content')
    @include('back.content-top', ['title' => 'Распродажа'])
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab_g1">
                ...
                <div class="box box-info group-item-widget" data-block="sale_list">
                    ...
                    <div class="box-body">
                        <div class="groupflat-widget group-item-wrap">
                            @foreach($block->sale_list_group as $item)
                                @include('back.groups.sale_list.sale_list_box', ['item' => $item])
                            @endforeach
                        </div>
                    </div>
                </div>
    ...
    <input class="form-control string" type="hidden" value="{{time()}}"
           data-name="last_modified" data-type="string" data-block="sale" data-id="0">
